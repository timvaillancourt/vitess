...
func InsertRecoveryDetection(analysisEntry *inst.ProblemAnalysis) error {
...
func AttemptRecoveryRegistration(analysisEntry *inst.ProblemAnalysis) (*TopologyRecovery, error) {
...
func readRecoveries(whereCondition string, limit string, args []any) ([]*TopologyRecovery, error) {
	...
	err := db.QueryVTOrc(query, args, func(m sqlutils.RowMap) error {
		topologyRecovery := *NewTopologyRecovery(inst.ProblemAnalysis{})
