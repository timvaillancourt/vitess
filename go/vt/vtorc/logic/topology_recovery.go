...
func NewTopologyRecovery(replicationAnalysis inst.ProblemAnalysis) *TopologyRecovery {
...
func recoverPrimaryHasPrimary(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
...
func runEmergencyReparentOp(ctx context.Context, analysisEntry *inst.ProblemAnalysis, recoveryName string, waitForAllTablets bool, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	// Read the tablet information from the database to find the shard and keyspace of the tablet
...
func recoverDeadPrimary(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
...
func recoverPrimaryTabletDeleted(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	return runEmergencyReparentOp(ctx, analysisEntry, "PrimaryTabletDeleted", true, logger)
}

func postErsCompletion(topologyRecovery *TopologyRecovery, analysisEntry *inst.ProblemAnalysis, recoveryName string, promotedReplica *inst.Instance) {
...
func checkAndRecoverLockedSemiSyncPrimary(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	logger.Warning("No actions in checkAndRecoverLockedSemiSyncPrimary")
	return false, nil, nil
}

// checkAndRecoverGenericProblem is a general-purpose recovery function
func checkAndRecoverGenericProblem(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (bool, *TopologyRecovery, error) {
...
func getCheckAndRecoverFunction(recoveryFunctionCode recoveryFunction) (
	checkAndRecoverFunction func(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error),
) {
	switch recoveryFunctionCode {
	case noRecoveryFunc:
		return nil
...
func analysisEntriesHaveSameRecovery(prevAnalysis, newAnalysis *inst.ProblemAnalysis) bool {
...
func executeCheckAndRecoverFunction(analysisEntry *inst.ProblemAnalysis) (err error) {
...
func recheckPrimaryHealth(analysisEntry *inst.ProblemAnalysis, discoveryFunc func(string, bool)) error {
...
func checkIfAlreadyFixed(analysisEntry *inst.ProblemAnalysis) (bool, error) {
	// Run a replication analysis again. We will check if the problem persisted
	analysisEntries, err := inst.GetProblemAnalysis(analysisEntry.ClusterDetails.Keyspace, analysisEntry.ClusterDetails.Shard, &inst.ProblemAnalysisHints{})
	if err != nil {
		return false, err
	}
...
func CheckAndRecover() {
	...
	replicationAnalysis, err := inst.GetProblemAnalysis("", "", &inst.ProblemAnalysisHints{AuditAnalysis: true})
	if err != nil {
		log.Error(err)
		return
	}
...
func postPrsCompletion(topologyRecovery *TopologyRecovery, analysisEntry *inst.ProblemAnalysis, promotedReplica *inst.Instance) {
	if promotedReplica != nil {
		message := fmt.Sprintf("promoted replica: %+v", promotedReplica.InstanceAlias)
		_ = AuditTopologyRecovery(topologyRecovery, message)
...
func electNewPrimary(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	topologyRecovery, err = AttemptRecoveryRegistration(analysisEntry)
...
func fixPrimary(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	topologyRecovery, err = AttemptRecoveryRegistration(analysisEntry)
	if topologyRecovery == nil {
...
func fixReplica(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	topologyRecovery, err = AttemptRecoveryRegistration(analysisEntry)
	if topologyRecovery == nil {
...
func recoverErrantGTIDDetected(ctx context.Context, analysisEntry *inst.ProblemAnalysis, logger *log.PrefixedLogger) (recoveryAttempted bool, topologyRecovery *TopologyRecovery, err error) {
	topologyRecovery, err = AttemptRecoveryRegistration(analysisEntry)
	if topologyRecovery == nil {
