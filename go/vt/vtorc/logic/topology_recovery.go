...
func getCheckAndRecoverFunctionCode(analysisCode inst.AnalysisCode, tabletAlias *topodatapb.TabletAlias) recoveryFunction {
	switch analysisCode {
	// primary
...
func recheckPrimaryHealth(analysisEntry *inst.ReplicationAnalysis, discoveryFunc func(*topodatapb.TabletAlias, bool)) error {
