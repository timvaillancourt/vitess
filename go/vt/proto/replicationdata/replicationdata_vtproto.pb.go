...
func (m *ConnectedReplica) CloneVT() *ConnectedReplica {
	if m == nil {
		return (*ConnectedReplica)(nil)
	}
	r := new(ConnectedReplica)
...
func (m *ConnectedReplica) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *FullStatus) CloneVT() *FullStatus {
	...
	if rhs := m.ConnectedReplicas; rhs != nil {
		tmpContainer := make([]*ConnectedReplica, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.ConnectedReplicas = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *ConnectedReplica) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ConnectedReplica) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ConnectedReplica) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FullStatus) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ConnectedReplicas) > 0 {
		for iNdEx := len(m.ConnectedReplicas) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.ConnectedReplicas[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ConnectedReplica) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FullStatus) SizeVT() (n int) {
	...
	if len(m.ConnectedReplicas) > 0 {
		for _, e := range m.ConnectedReplicas {
			l = e.SizeVT()
			n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *ConnectedReplica) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConnectedReplica: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConnectedReplica: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *FullStatus) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConnectedReplicas", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ConnectedReplicas = append(m.ConnectedReplicas, &ConnectedReplica{})
			if err := m.ConnectedReplicas[len(m.ConnectedReplicas)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
