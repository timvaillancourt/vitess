...
func (tm *TabletManager) FullStatus(ctx context.Context) (*replicationdatapb.FullStatus, error) {
	...
	return &replicationdatapb.FullStatus{
		...
		MysqlUp:                     tm.MySQLMonitor.IsMySQLAlive(),
		LastMysqlAliveAt:            protoutil.TimeToProto(tm.MySQLMonitor.LastMySQLAliveAt()),
		LastSemiSyncEnabledAt:       protoutil.TimeToProto(tm.MySQLMonitor.LastSemiSyncEnabledAt()),
		LastSemiSyncRunningAt:       protoutil.TimeToProto(tm.MySQLMonitor.LastSemiSyncRunningAt()),
